/* ════════════════════════════════════════════════════════════════
   AĒRIS — orchestration
   preloader · smooth scroll · DOM choreography · cursor physics
   ════════════════════════════════════════════════════════════════ */
...
try {
  ...
  console.warn('AĒRIS: WebGL unavailable, falling back to still air.', err);
...
/* ── Initial hidden states (veil covers everything) ──────────── */
if (!reducedMotion) {
...
if (!reducedMotion) {
  // hero recedes into the glass as you descend
  gsap.to('.hero-inner', {
  ...
  // headline words rise through their masks
  ...
  // manifesto — words condense out of the fog, tied to scroll
...
if (finePointer && !reducedMotion) {
  ...
  document.addEventListener('pointerover', (e) => {
    cursor.classList.toggle('is-link', !!e.target.closest('a, button, .card'));
  });
